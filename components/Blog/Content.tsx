...
export default function Content({
    ...
    return (
        <>
            <div className="mt-10">
                <h1 className="text-left text-6xl mt-14">{blog.title}</h1>
                <Image
                    width={900}
                    height={300}
                    ...
                    alt=""
                />
                <p className="text-center my-5 text-sm text-slate-400 inline-flex place-items-center w-full place-content-left">
                    <svg
                        className="w-5 h-5 fill-slate-400 mr-2"
                    ...
                    {new Date(blog._createdAt).toDateString()} by Willow
                </p>
                <p className="text-sm">{blog.description}</p>
                <br />
                <PortableTextComponent body={blog.body} />
            </div>
        </>
    );
}
